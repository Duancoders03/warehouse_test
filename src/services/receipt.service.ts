...
import { MOCK_SUPPLIERS, MOCK_WAREHOUSES, MOCK_EMPLOYEES, MOCK_ITEMS, MOCK_UNITS } from './master-data.service';

// In-Memory Storage for Demo & UI Testing without DB
...
// Helper to convert number to Vietnamese words for Mẫu 01-VT
